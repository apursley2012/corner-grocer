...
<p><a href="https://apursley2012.github.io/corner-grocer/"><img src="https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-222222?style=for-the-badge&amp;logo=githubpages&amp;logoColor=white" alt="Live Demo"></a> <img src="https://img.shields.io/badge/Python-3776AB?style=for-the-badge&amp;logo=python&amp;logoColor=white" alt="Python"> <img src="https://img.shields.io/badge/SQLite-003B57?style=for-the-badge&amp;logo=sqlite&amp;logoColor=white" alt="SQLite"> <img src="https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&amp;logo=html5&amp;logoColor=white" alt="HTML5"> <img src="https://img.shields.io/badge/CSS3-1572B6?style=for-the-badge&amp;logo=css3&amp;logoColor=white" alt="CSS3"> <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&amp;logo=javascript&amp;logoColor=black" alt="JavaScript"></p>

<p><strong>A grocery-frequency analysis project with item lookup, normalized search, sorting, histogram reporting, persistent Python/SQLite source, and a browser-accessible interactive version.</strong></p>

<p><a href="https://apursley2012.github.io/corner-grocer/">Open the live project</a> · <a href="https://github.com/apursley2012/corner-grocer">View the repository</a> · <a href="https://github.com/apursley2012/corner-grocer/issues/new/choose">Report an issue or request an addition</a></p>
...
*   [Source Application and Browser Experience 🖥️](#source-application-and-browser-experience)
...
| `#D6EADF` | Mint | Supporting panels and soft highlighted areas |
| `#F5F5E9` | Muted Cream | Product-card placeholders and subdued surfaces |
| `#8A173B` | Berry | Price and selective information emphasis |
| `#C8D7CF` | Soft Gray Green | Borders and form structure |
| `#FFFFFF` | White | Form controls and clean card surfaces |
...
The gallery uses paired, centered images when screenshots are present. Keep screenshots under `images/screenshots/` and use names such as `corner-grocer-screenshot-01.png`, `corner-grocer-screenshot-02.png`, and so on. I have not invented image filenames that were not verified in the current project source.
...
*   **Sort items alphabetically or by frequency**
*   **Search with case-insensitive and normalized singular/plural matching**
*   **Add browser-side items and preserve them with Local Storage**
*   **Download frequency and histogram reports**
*   **Include Python/SQLite source, case study, and technical articles**
...
*   **Python 3**
*   **SQLite**
*   **C++ source/history retained with the project**
...
[https://apursley2012.github.io/corner-grocer/](https://apursley2012.github.io/corner-grocer/)
...
| Page / Area | Purpose |
| --- | --- |
| `index.html` | Project overview and GitHub Pages entry |
| `demo.html` | Interactive browser version of the grocery-frequency application |
| `case-study.html` | Detailed project case study |
| `articles/` | Technical writing covering the major implementation stages |
| `downloads/` | Python, SQLite, utility, and source files |
...
Normalization is especially important for grocery data because `Apple`, `apple`, `apples`, and similar variations should not silently become unrelated inventory records. The search and frequency workflow therefore treats common case and singular/plural variations as the same item where the project rules allow it.
...
*   Add optional chart views beyond the text histogram
*   Add automated tests for normalization, sorting, and report generation
...
*   **Issues / Requests:** [https://github.com/apursley2012/corner-grocer/issues/new/choose](https://github.com/apursley2012/corner-grocer/issues/new/choose)
